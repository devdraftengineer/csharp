...
inputSpec: /Users/trustchocha/Desktop/sdk-dev/openapi/api.yml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{B95EFE7B-BFB1-4298-BCDC-DF54EBAE8735}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAPIHealthApi>();
            IHealthControllerCheckV0ApiResponse apiResponse = await api.HealthControllerCheckV0Async("todo");
            HealthResponseDto model = apiResponse.Ok();
        }
...
## Api Information
- appName: Devdraft AI Payment &amp; Business Management API
- appVersion: 1.0.0
- appDescription:  A comprehensive payment processing and business management API that enables seamless integration of cryptocurrency and traditional payment methods.     
